	...
	return (
		<div className="container">
			<div className="flex flex-col lg:flex-row items-center lg:items-end mb-8 lg:mb-16">
				<h1 className="text-white text-center lg:text-start mb-5 lg:flex-[3_3_0%] lg:text-[2rem]">
					Welcome to your mock interview for the
					<br />
					<span className="text-light-green text-[1.5em] lg:text-[1.1em]">
						{jobTitle} Position
					</span>
					<br />
					<span className="font-normal">
						at
						<span className="text-light-green"> {companyName}</span>
					</span>
				</h1>
				<img
					className="relative lg:top-[50px] lg:scale-150 w-full max-w-[75%] lg:max-w-[500px] lg:flex-1"
					src={InterviewStart}
					alt="Job interview underway"
				/>
			</div>
			<Card className="flex flex-col items-center relative mt-[-30px] z-[100] mb-5">
				...
				<p className="text-green mb-5">
					{responseText ? responseText : "Loading company details..."}
				</p>
				{responseText && (
					<ButtonLink to="/Interview">
						Start answering
						<br />
						Interview Questions
					</ButtonLink>
